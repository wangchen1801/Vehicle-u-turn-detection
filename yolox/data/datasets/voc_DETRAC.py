...
from .voc_classes_DETRAC import VOC_CLASSES
...
class VehicleDetection(Dataset):
    ...
    def __init__(
        ...
        # img_size=(416, 416),
        image_sets=[("UA-DETRAC", "trainval")],
        img_size=(960, 540),  # unused
        preproc=None,
        ...
        self.root = data_dir  # ./datasets/VOCdevkit
        ...
        self.ids = list()
        for (year, name) in image_sets:  # year = UA-DETRAC
            self._year = year
            ...
            for line in open(
                ...
                line = line.split(' ')
                # line = [item.strip('./\n') for item in line]  # [img_path, xml_path], relative
    ...
    def load_anno_from_ids(self, index):
        ...
        target = ET.parse(os.path.join(self.root, self.name, img_id[1].strip('./\n'))).getroot()
    ...
    def load_resized_img(self, index):
        ...
        r = min(self.img_size[0] / img.shape[0], self.img_size[1] / img.shape[1])  # # 按比例小的一边缩放（小）
    ...
    def load_image(self, index):
        ...
        img_path = os.path.join(self.root, self.name, img_id[0].strip('./'))
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self.root, self._year)
    ...
    def _do_python_eval(self, output_dir="output", iou=0.5):
        ...
        imagesetfile = os.path.join(rootpath, "labels" + ".txt")
